...
public class Email {
    ...
    private String generate_password(int length) {
        ...
        String symbol = "!@#$%^&*()_+?";
        String values = Capital_chars + small_chars + number + symbol;
        String password = "";
    ...
    public void set_mailCap() {
        System.out.println("Current capacity = " + this.mailCappacity + "mb");
        System.out.println("Enter new mailbox capacity:");
        this.mailCappacity = s.nextInt();
    ...
    public void getInfo() {
        ...
        System.out.println("Passwoard:" + this.password);
        System.out.println("Mailbox capacity:" + this.mailCappacity + "mb");
